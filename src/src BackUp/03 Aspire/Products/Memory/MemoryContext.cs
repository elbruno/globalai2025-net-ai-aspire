...
public class MemoryContext
{
    ...
    /// <summary>
    /// Searches for a product based on the given search string.
    /// </summary>
    /// <param name="search">The search string to find the product.</param>
    /// <param name="db">The database context to query product details.</param>
    /// <returns>A <see cref="SearchResponse"/> containing the search results and response text.</returns>
    /// <exception cref="Exception">Throws an exception if an error occurs during the search process.</exception>
